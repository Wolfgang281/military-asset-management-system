...
const STATUSES = ["All Statuses", "pending", "in_transit", "completed"];
...
const STATUS_STYLE = {
  ...
  in_transit: "bg-blue-500/10  border-blue-500/20  text-blue-400",
...
const TransferFilters = ({ filters, onChange, onApply, loading }) => {
